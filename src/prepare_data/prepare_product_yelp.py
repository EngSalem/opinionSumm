...
get_rev_summ_pairs(amazon_train_df).to_csv(amazon_df +'/sum_pairs/amazon_train_df.csv', index=False)
get_rev_summ_pairs(amazon_valid_df).to_csv(amazon_df + '/sum_pairs/amazon_valid_df.csv', index=False)
get_rev_summ_pairs(amazon_test_df).to_csv(amazon_df+ '/sum_pairs/amazon_test_df.csv', index=False)

## combine reviews and summaries yelp
get_rev_summ_pairs(yelp_train_df).to_csv(yelp_df + '/sum_pairs/yelp_train_df.csv', index=False)
get_rev_summ_pairs(yelp_valid_df).to_csv(yelp_df + '/sum_pairs/yelp_valid_df.csv', index=False)
get_rev_summ_pairs(yelp_test_df).to_csv(yelp_df + '/sum_pairs/yelp_test_df.csv', index=False)
